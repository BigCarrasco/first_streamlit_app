...
#segundo data frame con conexion a snowflake
...
second_frame = streamlit.text_input('What fruit would you like to add?','jackfruit')
streamlit.write('The user entered ', second_frame)
